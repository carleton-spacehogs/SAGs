...
for SAG in ['C09','E23','K20','M21','N22']:
	data=pd.read_csv("./SeqObj/"+SAG+"_violin_SAAVs_no_KO_data.txt",sep='\t')
	...
	sns.set_color_codes()
	fig = plt.figure(figsize=(10,10), dpi=200) #i think this adjusts the size
	...
	plt.ylabel('SAAV/SNV ratio')
	plt.savefig(SAG+'_violin.png')
