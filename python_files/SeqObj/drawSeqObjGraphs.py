...
def make_sequence_objects(SAG):
	...
	x = populateContigLists.populate_contig_lists(opl[0], opl[1], opl[2], ORFs)
...
#		
#		
#		#returnList = make_DataFrame('scatter_ORF_ITEP_cluster', SeqObjDict[SAG])
#		#df = returnList[0]
#		#colors = returnList[1]
#		#df.plot.scatter(x='SAAVs',y='n2n1',c=colors,alpha=0.5)
#		#plt.show()
#		
#		df_list.append(df)
#		#color_list += colors
...
#	plt.savefig('SNVs_vs_n2n1_scatter_all_SAGs.svg')
# 
#		
#	
#	
